...
export async function withdrawVicuna({ walletClient, vaultAddress, amount, }) {
    ...
    const parsedAmount = parseUnits(amount, await getERC20Decimals({ publicClient, tokenAddress: vaultConfig.token }));
