    ...
    return (
        <div>
            ...
            <div className="flex flex-col space-y-2">
                ...
                <button
                    className="block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                    onClick={() => depositEggsLeverage({ walletClient: wallet, amount: "0.001" })}
                >
                    Deposit Egs Leverage
                </button>
                <button className="block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => {
                    getOriginOSAPY().then(result => {
                        console.log(result);
                    }).catch(error => {
                        console.error(error);
                    });
