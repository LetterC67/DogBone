...
import { getERC20Balance, approveERC20, checkNeedApproval, getERC20Decimals, } from '../utils/erc20Utils';
...
export async function depositIchiLPBeefy({ walletClient, vaultAddress, amount, }) {
    ...
    const parsedAmountIn = parseUnits(amount, await getERC20Decimals({ publicClient, tokenAddress: beefyLPConfig.token }));
