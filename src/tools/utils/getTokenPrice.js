...
const BSC_USDT = "0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d";
const SONIC_USDC = "0x29219dd400f2Bf60E5a23d13Be72B486D4038894";
const SOLV_BTC_BBN = "0xCC0966D8418d412c599A6421b760a847eB169A8c";
const SOLV_BTC = "0x541FD749419CA806a8bc7da8ac23D346f2dF8B77";
const WSTK_SCUSD = "0x9fb76f7ce5fceaa2c42887ff441d46095e494206";
const WSTK_SCETH = "0xe8a41c62bb4d5863c6eadc96792cfe90a1f37c47";
...
export async function getTokenPriceBySymbol(tokenSymbol) {
    const token = tokenList.tokens.find((token) => token.symbol === tokenSymbol);
    if (!token) {
        throw new Error(`Token ${tokenSymbol} not found`);
    }
    return await getTokenPriceByAddress(token.address, token.chainId);
}
export async function getTokenPriceByAddress(token, chainId) {
    console.log("?????????????????????");
    console.log(token);
...
export async function getTokenPriceByAddresses(tokenAddresses, chainId) {
    const result = [];
