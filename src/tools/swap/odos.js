export async function getOdosSwapQuote({ receiver, chainId, tokenIn, tokenOut, amountIn, }) {
    ...
    if (response.status === 200) {
        ...
        throw new Error('Error in getting Odos Swap Quote to swap ' +
            amountIn +
            ' ' +
            tokenIn +
            ' to ' +
...
export async function odosAssemble(receiver, pathId) {
...
export async function odosExecute({ receiver, chainId, tokenIn, tokenOut, amountIn, }) {
