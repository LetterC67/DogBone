...
import { getERC20Balance, getERC20Decimals, checkNeedApproval, approveERC20, } from '../utils/erc20Utils';
const siloAbi = JSON.parse(JSON.stringify(SiloAbi));
const vaultList = JSON.parse(JSON.stringify(VaultList));
export async function depositSilo({ walletClient, vaultAddress, amount, }) {
