...
const BORROW_TOKEN: Address = '0xd3DCe716f3eF535C5Ff8d041c1A41C3bd89b97aE';
const SHARE_DEBT_TOKEN: Address = '0xE34841964003d4957936A4c94d3B0aC378153164';
...
export async function depositDogBone_Bone5({
  walletClient,
  amount,
  leverage
}: DepositDogBone) {
