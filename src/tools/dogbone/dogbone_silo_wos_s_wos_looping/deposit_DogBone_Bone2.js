...
const LEVERAGE = 9;
const SILO_VAULT = '0x1d7E3726aFEc5088e11438258193A199F9D5Ba93';
// const SILO_CONFIG: Address = "0x78C246f67c8A6cE03a1d894d4Cf68004Bd55Deea";
const TOKEN = '0x9F0dF7799f6FDAd409300080cfF680f5A23df4b1';
const BORROW_TOKEN = '0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38';
const SHARE_DEBT_TOKEN = '0xb8abA7c4e192De20e67D4229326C92ADC5f664ea';
export async function depositDogBone_Bone2({ walletClient, amount, }) {
    ...
    const parsedAmountIn = parseUnits(amount, await getERC20Decimals({ publicClient, tokenAddress: TOKEN }));
    const [TOKEN_PRICE, BORROW_TOKEN_PRICE] = await getTokenPriceByAddresses([
        TOKEN,
        BORROW_TOKEN,
    ]);
    const flashAmount = (Number(amount) * (LEVERAGE - 1) * TOKEN_PRICE) / BORROW_TOKEN_PRICE;
    const parsedFlashAmount = parseUnits(flashAmount.toString(), await getERC20Decimals({ publicClient, tokenAddress: BORROW_TOKEN }));
