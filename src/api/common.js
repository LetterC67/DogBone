import { getERC20Balance, getERC20Decimals, } from '../tools/utils/erc20Utils';
import { sonic, polygon, base, arbitrum, mainnet } from 'viem/chains';
import { createPublicClient, custom, } from 'viem';
import { ethers } from 'ethers';
async function getUserBalance(client, userAddress, tokenAddress, chainName, lastId = null) {
    ...
    if ((lastId == null && client.chainId.slice(7, client.chainId.length) !== chain.id.toString()) ||
