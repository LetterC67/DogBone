...
function SendTransaction() {
    ...
    return (_jsx("button", { onClick: sendTx, disabled: !user?.wallet, className: "px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 mr-2 mt-4", children: "Send 0.01 ETH to Yourself" }));
}
